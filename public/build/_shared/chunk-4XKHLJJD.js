...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712773130795.2668";
}
function Modal({
  onClose
}) {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "md:hidden flex-col flex gap-1.5 mx-auto", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex justify-around", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex-col flex items-start", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { value: name, onChange: (e) => setName(e.target.value), className: "p-2 rounded-[5px] bg-mainColor border border-black !w-fit" }, void 0, false, {
            fileName: "app/routes/contact.tsx",
            lineNumber: 135,
            columnNumber: 13
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex-col flex items-start", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { value: lastName, onChange: (e) => setLastName(e.target.value), className: "p-2 rounded-[5px] !w-fit bg-mainColor border border-black" }, void 0, false, {
            fileName: "app/routes/contact.tsx",
            lineNumber: 139,
            columnNumber: 13
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex justify-around", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex-col flex items-start", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { value: email, onChange: (e) => setEmail(e.target.value), className: "p-2 rounded-[5px] !w-fit bg-mainColor border border-black" }, void 0, false, {
            fileName: "app/routes/contact.tsx",
            lineNumber: 145,
            columnNumber: 13
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex-col flex items-start", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { value: Object, onChange: (e) => setSubject(e.target.value), className: "p-2  rounded-[5px] !w-fit bg-mainColor border border-black" }, void 0, false, {
            fileName: "app/routes/contact.tsx",
            lineNumber: 150,
            columnNumber: 13
          }, this)
...
//# sourceMappingURL=/build/_shared/chunk-4XKHLJJD.js.map

...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712765907050.0723";
}
var Description = () => {
  _s();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: `w-full h-auto flex flex-col ${isServicesSectionVisible ? "bg-mainColor" : "bg-yellowHome"}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-auto h-full relative", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { id: "scrolling-text", className: `flex items-center justify-end pr-10 gap-3 relative w-full ${scrolled ? "scrolling" : "hidden"}`, children: [
...
//# sourceMappingURL=/build/_shared/chunk-ILUCCR27.js.map

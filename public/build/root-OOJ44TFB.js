...
// app/tailwind.css
var tailwind_default = "/build/_assets/tailwind-4DNDDSRQ.css";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712993616619.0417";
}
var Menu = () => {
  _s();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
    ...
    }, className: `${headerColor} hidden md:hidden mx-auto justify-between items-center py-[30px] px-[40px]`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "md:hidden", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: `${headerColor} flex justify-between items-center py-[32px] px-[30px] mt-2`, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "md:hidden flex items-center mb-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: toggleMenu, className: "text-grayBlack focus:outline-none flex gap-1", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { initial: {
            y: 10,
            opacity: 0,
            scale: 0.5
      ...
      isMenuOpen && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { initial: {
        ...
        duration: 0.5
      }, className: "bg-yellowHome z-[999] flex flex-col gap-12 justify-center items-center fixed top-0 left-0 w-full h-full w-full h-full z-50 overflow-y-auto", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute top-5 right-5", onClick: toggleMenu, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Close_default, { className: "w-8 h-8" }, void 0, false, {
          fileName: "app/components/header/index.tsx",
          lineNumber: 159,
          columnNumber: 15
        }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/root-OOJ44TFB.js.map

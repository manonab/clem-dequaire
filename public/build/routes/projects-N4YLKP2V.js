...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712941991305.4236";
}
function Project() {
  _s();
  const {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full flex flex-col gap-6 md:gap-12 items-start justify-center ml-10", children: [
...
//# sourceMappingURL=/build/routes/projects-N4YLKP2V.js.map

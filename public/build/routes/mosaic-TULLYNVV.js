...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712991838140.5059";
}
function Mosaic() {
  _s();
  const {
  ...
  const mosaicContent = [{
    title: "mission.",
    content: "Mosaic est une association de d\xE9fense des droits des personnes LGBTQ+ de 12 \xE0 18 ans. Ils proposent des services d\u2019\xE9coute et d\u2019animations pour les jeunes et leurs proches."
  }, {
    title: "objectifs",
    content: "Augmenter la visibilit\xE9 globale de l\u2019association avec un plan de communication adapt\xE9, de nouveaux concepts et en accord avec le ton et le design d\xE9j\xE0 mis en place."
  }];
  const handleGoBack = () => {
    router(-1);
  };
...
//# sourceMappingURL=/build/routes/mosaic-TULLYNVV.js.map

...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712682678115.1416";
}
function Project() {
  _s();
  const {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full flex flex-col gap-6 md:gap-12 items-start mx-16 my-10 md:my-auto", children: [
...
//# sourceMappingURL=/build/routes/projects-JK3AXN3C.js.map

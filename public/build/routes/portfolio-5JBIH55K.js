...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712992594749.375";
}
function PortFolio() {
  _s();
  const {
  ...
  const portfolioContent = [{
    title: "Concept.",
    content: "J'ai con\xE7u ce portfolio comme une introduction \xE0 mon univers, mon style et mes valeurs. Des arri\xE8re-plans neutres mais des couleurs de texte satur\xE9es, une police douce mais imposante... L\u2019ensemble se pose en miroir de mes engagements et croyances : un design simple, \xE9pur\xE9 mais r\xE9solument affirm\xE9."
  }, {
    title: "Intention",
    ...
    content: "audacieux, fluide, engag\xE9"
  }];
  const handleGoBack = () => {
    router(-1);
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full flex-col items-center justify-center mx-auto", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-saumon flex flex-col gap-3 justify-center py-10", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex gap-6 items-center w-full overflow-auto h-full size-12 px-4 py-6", ref: contentRef, children: [
...
//# sourceMappingURL=/build/routes/portfolio-5JBIH55K.js.map

...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712939226424.2576";
}
function Capiche() {
  _s();
  const {
  ...
  const capicheContent = [{
    ...
    content: "La conception du site web et de l'application mobile a \xE9t\xE9 r\xE9alis\xE9e sur Figma, en respectant les principes de l'UX design. Une attention particuli\xE8re a \xE9t\xE9 port\xE9e sur la pertinence des recherches des consommateurs et les suggestions personnalis\xE9es."
  }];
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full flex-col items-center justify-center mx-auto", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "py-20 bg-saumon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { onClick: () => router("/projects"), className: "py-2 px-2 transition-all duration-300 ease-in-out font-bold text-[10px] text-center text-grayBlack uppercase hover:text-white hover:bg-grayBlack translate hover:cursor-pointer border-black border rounded-full min-w-[100px] max-w-[130px] mx-auto", children: "Autres projets" }, void 0, false, {
      fileName: "app/routes/capiche.tsx",
      lineNumber: 87,
      columnNumber: 9
    }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/capiche-FTP6YWGZ.js.map

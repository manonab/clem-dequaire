...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1708018007523.4712";
}
var Menu = () => {
  _s();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { initial: {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { onClick: () => router("/home"), className: "hover:cursor-pointer", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-orange font-kateMedium text-[52px] leading-8", children: "C." }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex justify-center items-center gap-4", children: pathTextMapping.map((route) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-auto", onClick: () => router(`${route.path}`), children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "leading-4 text-grayBlack hover:cursor-pointer text-[18px] font-clash text-black", children: route.name }, void 0, false, {
      fileName: "app/components/header/index.tsx",
      lineNumber: 60,
      columnNumber: 13
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { onClick: () => router("/contact"), children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-[15px] hover:cursor-pointer font-clashSemibold uppercase underline", children: "Rencontrons-nous" }, void 0, false, {
      fileName: "app/components/header/index.tsx",
      lineNumber: 66,
      columnNumber: 9
    }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/root-WGRTSGJB.js.map
